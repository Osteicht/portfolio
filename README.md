...
🛠️ Core Tech Stack
    ...
    Database: PostgreSQL
    Real-Time & APIs: Socket.io (WebSockets), Meta Graph API, Telegram Bot API, Groq (LLMs)
    Security: Helmet, CORS, Express-Validator, Rate-Limiting, OAuth2 (Passport)
...
This specific repository holds the source code for my static portfolio website. It is intentionally simple, fast, and lightweight, built using basic HTML/CSS and deployed via GitHub Pages.

🤝 Let's Work Together

Looking for a developer to build a functioning, performance-oriented web app or integrate smart API solutions? I am currently open for freelance projects.
